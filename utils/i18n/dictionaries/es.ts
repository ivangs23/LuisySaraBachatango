export const es = {
  ...
  lesson: {
    ...
    assignmentInReview: "Tu entrega está en revisión. Te avisaremos cuando el profesor la corrija.",
    assignmentFeedbackLabel: "Feedback del profesor:",
    assignmentUrlLabel: "Enlace a tu vídeo o material (opcional)",
    assignmentUrlPlaceholder: "https://... (YouTube, Drive, etc.)",
    assignmentError: "No se pudo enviar la entrega. Inténtalo de nuevo.",
    assignmentEmptyDescription: "Sin descripción para esta lección.",
    ...
    videoProcessing: "El vídeo de esta lección todavía se está procesando. Vuelve en unos minutos."
  },
  dashboard: {
    title: "Mis Cursos",
    viewClass: "VER CLASE",
  ...
  signup: {
    ...
    panelTitle: "Tu primera ",
    panelTitleEmphasis: "clase",
    panelTitleSuffix: " empieza con un paso.",
  ...
  forgotPassword: {
    ...
    panelTitle: "Vuelve a la ",
    panelTitleEmphasis: "pista",
    panelTitleSuffix: " en un par de pasos.",
  ...
  profile: {
    ...
    roleAdmin: "ADMIN",
    rolePremium: "PREMIUM",
    roleAdminFull: "Administrador",
    subscriptionActiveBadge: "Suscripción activa",
    sinceBadge: "Desde {date}",
    coursesPurchased: "Cursos comprados",
    ...
    noPlanActive: "No hay plan activo",
  ...
  notifications: {
    ...
    commentLike: "dio like a tu comentario",
    commentReply: "respondió a tu comentario",
    postComment: "comentó tu publicación",
    postLike: "dio like a tu publicación",
    assignmentGraded: "Tu tarea ha sido corregida",
    defaultText: "Notificación"
  },
  community: {
    ...
    noResultsSub: "Prueba con otra búsqueda o publica el primer post sobre el tema.",
    noPosts: "Todavía no hay posts",
    noPostsSub: "Sé el primero en compartir algo con la comunidad.",
    ...
    postEyebrow: "POST DE LA COMUNIDAD",
    loginCta: "Inicia sesión",
    toLeaveComment: "para dejar un comentario.",
    noCommentsYet: "No hay comentarios todavía. Sé el primero en participar.",
    prevComments: "← Anteriores",
