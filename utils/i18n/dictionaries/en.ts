...
export const en: Dictionary = {
  ...
  lesson: {
    ...
    assignmentInReview: "Your submission is under review. We'll let you know when the teacher grades it.",
    assignmentFeedbackLabel: "Teacher's feedback:",
    assignmentUrlLabel: "Link to your video or material (optional)",
    assignmentUrlPlaceholder: "https://... (YouTube, Drive, etc.)",
    assignmentError: "Your submission could not be sent. Please try again.",
    assignmentEmptyDescription: "No description for this lesson.",
    ...
    videoProcessing: "This lesson's video is still processing. Check back in a few minutes."
  },
  dashboard: {
    title: "My Courses",
  ...
  login: {
    ...
    panelTitle: "Dance is ",
    panelTitleEmphasis: "remembering",
    panelTitleSuffix: " with your body.",
  ...
  signup: {
    ...
    panelTitle: "Your first ",
    panelTitleEmphasis: "class",
    panelTitleSuffix: " starts with one step.",
  ...
  forgotPassword: {
    ...
    panelTitle: "Get back on the ",
    panelTitleEmphasis: "floor",
    panelTitleSuffix: " in a few steps.",
  ...
  profile: {
    ...
    subscriptionActiveBadge: "Active subscription",
    sinceBadge: "Since {date}",
  ...
  errors: {
    ...
    email_not_confirmed: "Your email is not confirmed yet. Check your inbox (and spam), or ask us to send the confirmation again.",
  ...
  notifications: {
    ...
    assignmentGraded: "Your assignment has been graded",
  ...
  community: {
    ...
    noResultsSub: "Try another search or be the first to post about it.",
    ...
    publish: "Post",
    backToCommunity: "Back to the community",
    postEyebrow: "COMMUNITY POST",
    loginCta: "Log in",
    toLeaveComment: "to leave a comment.",
    noCommentsYet: "No comments yet. Be the first to join in.",
    prevComments: "← Previous",
    nextComments: "Next →",
