...
export const dictionaries = {
  ...
  de: {
    ...
    login: {
      ...
      panelTitle: "Tanzen ist ",
      panelTitleEmphasis: "erinnern",
      panelTitleSuffix: " mit dem Körper.",
    ...
    signup: {
      ...
      panelTitle: "Deine erste ",
      panelTitleEmphasis: "Stunde",
      panelTitleSuffix: " beginnt mit einem Schritt.",
    ...
    forgotPassword: {
      ...
      panelTitle: "Zurück auf die ",
      panelTitleEmphasis: "Tanzfläche",
      panelTitleSuffix: " in wenigen Schritten.",
